...
// Mon Nov 30 09:34:19 2020 by ROOT version 6.12/07
// from TTree gen_tree/gen tree
// found on file: SPS_JJ_noGenCut_27Nov2020.root
//////////////////////////////////////////////////////////
...
std::ofstream EventDumpFile_J1;
std::ofstream EventDumpFile_J2;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("SPS_JJ_noGenCut_27Nov2020.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("SPS_JJ_noGenCut_27Nov2020.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("SPS_JJ_noGenCut_27Nov2020.root:/GenAnalyzer");
