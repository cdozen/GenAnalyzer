...
// Fri Nov 27 11:37:05 2020 by ROOT version 6.12/07
// from TTree gen_tree/gen tree
// found on file: /eos/uscms/store/user/muahmad/FourMuon_Analysis/NTuples/NTuples_JJ/GENonly_MC/SPSToJJ_13TeV_pythia8.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<double>  *GENups_Daughter_murapidity;
   vector<double>  *GENups_Daughter_muphi;
   vector<double>  *GENups_Daughter_mumass;
   vector<int>     *GENups_Daughter_muid;
...
#ifdef deneme_cxx
deneme::deneme(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/muahmad/FourMuon_Analysis/NTuples/NTuples_JJ/GENonly_MC/SPSToJJ_13TeV_pythia8.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/uscms/store/user/muahmad/FourMuon_Analysis/NTuples/NTuples_JJ/GENonly_MC/SPSToJJ_13TeV_pythia8.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/uscms/store/user/muahmad/FourMuon_Analysis/NTuples/NTuples_JJ/GENonly_MC/SPSToJJ_13TeV_pythia8.root:/GenAnalyzer");
...
Int_t deneme::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t deneme::LoadTree(Long64_t entry)
{
...
void deneme::Show(Long64_t entry)
{
...
Int_t deneme::Cut(Long64_t entry)
{
