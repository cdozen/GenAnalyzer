...
// Mon Nov 23 17:47:08 2020 by ROOT version 6.12/07
// from TTree FourMu_tree/A ROOT tree
// found on file: ../DPS2JJwSPS/DPS2JJ_highestPtSelection.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        Pt_upsilon_high;
   Double_t        Eta_upsilon_high;
   Double_t        Y_upsilon_high;
   Double_t        Phi_upsilon_high;
   Double_t        mu1_pt;
   Double_t        mu1_eta;
   Double_t        mu1_phi;
   Double_t        mu2_pt;
   ...
   TBranch        *b_Pt_upsilon_high;   //!
   TBranch        *b_Eta_upsilon_high;   //!
   TBranch        *b_Y_upsilon_high;   //!
   TBranch        *b_Phi_upsilon_high;   //!
   TBranch        *b_mu1_pt;   //!
   TBranch        *b_mu1_eta;   //!
   TBranch        *b_mu1_phi;   //!
   TBranch        *b_mu2_pt;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../DPS2JJwSPS/DPS2JJ_highestPtSelection.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../DPS2JJwSPS/DPS2JJ_highestPtSelection.root");
      }
...
void FMu::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Pt_upsilon_high", &Pt_upsilon_high, &b_Pt_upsilon_high);
   fChain->SetBranchAddress("Eta_upsilon_high", &Eta_upsilon_high, &b_Eta_upsilon_high);
   fChain->SetBranchAddress("Y_upsilon_high", &Y_upsilon_high, &b_Y_upsilon_high);
   fChain->SetBranchAddress("Phi_upsilon_high", &Phi_upsilon_high, &b_Phi_upsilon_high);
