...
// Thu Oct 29 16:43:27 2020 by ROOT version 6.21/01
// from TTree FourMu_tree/A ROOT tree
// found on file: DPSJJ_without_genfiler_2018_with_etptcut_muonid.root
//////////////////////////////////////////////////////////
...
#ifdef FMu_muid_cxx
FMu_muid::FMu_muid(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("DPSJJ_without_genfiler_2018_with_etptcut_muonid.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("DPSJJ_without_genfiler_2018_with_etptcut_muonid.root");
      }
...
Int_t FMu_muid::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FMu_muid::LoadTree(Long64_t entry)
{
...
void FMu_muid::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("mu2_id", &mu2_id, &b_mu2_id);
   fChain->SetBranchAddress("mu3_id", &mu3_id, &b_mu3_id);
   fChain->SetBranchAddress("mu4_id", &mu4_id, &b_mu4_id);
...
void FMu_muid::Show(Long64_t entry)
{
...
Int_t FMu_muid::Cut(Long64_t entry)
{
