...
void DoubleJpsi_mixmu1only(){
    ...
    TFile *f = new TFile("/Users/candandozen/Desktop/Gen_level_eventmixing/TruthNtupMaker/Event_mixing_oldDRmethod/WithoutGenFilter/DPSJJ_Nogencut2018_nocuts.root");  
	...
	std::vector<TLorentzVector> mu34_p4_vector;
        ...
        int Ntotal = 100000;//fTree->GetEntries();
        cout << "!!***************************************!!\n";
        cout << " Readed   :" << Ntotal << "\n";
        cout << "!!***************************************!!\n";
	//Read the event
