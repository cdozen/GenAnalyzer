...
void DoubleJpsi_mix_noetapt(){
    ...
    TFile *f = new TFile("../../../PlotMaker/7Nov2020_DPSJJ_WITH_genfilter_2018_NO_etptcut.root");  
...
//mixing yontem mu12 ile mu34 mix et. 
	...
	cmix->SaveAs("plots_With_genfilt_NO_etaptcuts_NewDR01/cmix.png");
        c4mu->cd();
	...
	hmix->SetLineColor(kRed);
	hmix->Draw("e1same");
        c4mu->SaveAs("plots_With_genfilt_NO_etaptcuts_NewDR01/c4mu.png");
	c2j->cd();
	hMDoubleJpsi->Draw("e1");
        c2j->SaveAs("plots_With_genfilt_NO_etaptcuts_NewDR01/c2j.png");
